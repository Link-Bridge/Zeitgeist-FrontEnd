...
const Home = () => {
  ...
  return (
    <main className='min-h-full overflow-y-auto overflow-x-hidden grid grid-cols-1 lg:grid-cols-3 gap-4 h-full'>
      <section className='bg-[#FAFAFA] rounded-xl p-5 sm:p-8 lg:col-span-2 font-["Didot"] shadow-lg mb-6'>
      ...
      <section className='bg-[#FAFAFA] rounded-xl basis-2/6 p-5 sm:p-8 font-["Didot"] shadow-lg flex-1 min-w-[285px] mb-6'>
